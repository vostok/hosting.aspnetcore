...
[TestFixture(true)]
public class HealthCheckIntegrationWebApplicationTests : HealthCheckIntegrationTests
{
    public HealthCheckIntegrationWebApplicationTests(bool webApplication)
        : base(webApplication)
    {
    }
