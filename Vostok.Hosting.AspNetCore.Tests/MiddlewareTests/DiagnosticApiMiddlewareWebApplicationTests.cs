...
[TestFixture(true)]
public class DiagnosticApiMiddlewareWebApplicationTests : DiagnosticApiMiddlewareTests
{
    public DiagnosticApiMiddlewareWebApplicationTests(bool webApplication)
        : base(webApplication)
    {
    }
